...
interface PageHeaderProps {
  ...
  colorTheme?: 'blue' | 'red' | 'green' | 'purple' | 'orange' | 'indigo' | 'gray';
}
...
const colorThemes = {
  blue: {
    iconBg: 'bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30',
    iconColor: 'text-blue-600 dark:text-blue-400',
    titleGradient: 'from-blue-900 to-indigo-700 dark:from-blue-100 dark:to-indigo-200',
    accent: 'blue-600 dark:blue-400'
  },
  red: {
    iconBg: 'bg-gradient-to-r from-red-100 to-pink-100 dark:from-red-900/30 dark:to-pink-900/30',
    iconColor: 'text-red-600 dark:text-red-400',
    titleGradient: 'from-red-900 to-pink-700 dark:from-red-100 dark:to-pink-200',
  ...
  green: {
    ...
    titleGradient: 'from-green-900 to-emerald-700 dark:from-green-100 dark:to-emerald-200',
  ...
  purple: {
    ...
    titleGradient: 'from-purple-900 to-violet-700 dark:from-purple-100 dark:to-violet-200',
  ...
  orange: {
    ...
    titleGradient: 'from-orange-900 to-amber-700 dark:from-orange-100 dark:to-amber-200',
    accent: 'orange-600 dark:orange-400'
  },
  indigo: {
    iconBg: 'bg-gradient-to-r from-indigo-100 to-purple-100 dark:from-indigo-900/30 dark:to-purple-900/30',
    iconColor: 'text-indigo-600 dark:text-indigo-400',
    titleGradient: 'from-indigo-900 to-purple-700 dark:from-indigo-100 dark:to-purple-200',
    accent: 'indigo-600 dark:indigo-400'
  },
  gray: {
    iconBg: 'bg-gradient-to-r from-gray-100 to-slate-100 dark:from-gray-800 dark:to-slate-800',
    iconColor: 'text-gray-600 dark:text-gray-400',
    titleGradient: 'from-gray-900 to-slate-700 dark:from-gray-100 dark:to-slate-200',
    ...
    <div className="px-6 py-4 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <div className={`inline-flex items-center justify-center w-8 h-8 rounded-lg ${theme.iconBg} border border-opacity-20 border-current`}>
            <Icon className={`w-4 h-4 ${theme.iconColor}`} />
          </div>
          <div>
            <h2 className={`text-xl font-semibold bg-gradient-to-r ${theme.titleGradient} bg-clip-text text-transparent`}>
              {title}
            </h2>
            {subtitle && (
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm hover:shadow-md transition-all duration-200 group">
      <div className="flex items-start justify-between">
        <div className="flex items-start space-x-4">
          <div className={`flex-shrink-0 w-12 h-12 rounded-xl ${theme.iconBg} border border-opacity-20 border-current flex items-center justify-center group-hover:scale-105 transition-transform duration-200`}>
...
export const ProgressBar: React.FC<ProgressBarProps> = ({
  ...
  return (
    <div className={`flex items-center space-x-3 ${className}`}>
      <div className={`flex-1 bg-gray-200 dark:bg-gray-700 rounded-full ${sizeClasses[size]} overflow-hidden`}>
        <div
  ...
  return (
    <div className="h-full flex items-center justify-center px-6 py-6">
      <div className="text-center space-y-8 max-w-2xl">
        <div className={`inline-flex items-center justify-center w-24 h-24 rounded-2xl ${theme.iconBg} border border-opacity-20 border-current shadow-lg`}>
          <Icon className={`w-12 h-12 ${theme.iconColor}`} />
        </div>

        <div>
          <h3 className={`text-2xl font-bold bg-gradient-to-r ${theme.titleGradient} bg-clip-text text-transparent mb-3`}>
            {title}
          </h3>
